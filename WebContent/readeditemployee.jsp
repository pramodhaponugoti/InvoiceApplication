...
<div class="container">
    <div class="row">
        <f:form role="form" action="updateEmployee" method="POST" commandName="employeeCommand" >
            <div class="col-lg-4">
                ...
                <div class="form-group">
                    <label >Title </label>
                    <div class="input-group">
                        <f:input   class="form-control"  path="title" placeholder="Enter Title" readonly="true" />
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <f:input   class="form-control"  path="billRate" placeholder="Enter Bill Rate"  readonly="true"/>
                        <span class="input-group-addon"></span>
                    </div>
                </div>
               ...
               <div class="form-group">
                    <label >Role </label>
                    <div class="input-group">
                        <f:select   class="form-control"  path="role"  disabled="true">
