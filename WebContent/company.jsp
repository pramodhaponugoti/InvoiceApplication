...
<div class="container">
    <div class="row">
        <f:form role="form" action="addCompany" method="POST" commandName="companyCommand">
            <div class="col-lg-4">
               
                <div class="form-group">
                    <label >Name </label>
                    <div class="input-group">
                        <f:input  class="form-control" path="name" placeholder="Enter Name" required="true" />
              ...
              <input type="submit" name="submit" id="submit" value="AddCompany" size="5" class="btn btn-primary">
