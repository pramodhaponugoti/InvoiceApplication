            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <f:input  class="form-control" path="clientNumber" readonly="true" placeholder="Enter Number" required="true"/>
                ...
                <div class="form-group">
                    <label >Name </label>
                    <div class="input-group">
                        <f:input  class="form-control" path="name" id="nameId" placeholder="Enter Name"  />
